...
create table if not exists game_saves (
  ...
  save_data jsonb not null default '{"stats":{"hunger":4,"happiness":4,"affinity":0,"age":0,"weight":10,"sick":false,"poop_count":0,"alive":true},"last_hunger_decay":0,"last_happiness_decay":0,"last_affinity_decay_hunger":null,"last_affinity_decay_happiness":null,"poop_timers":[],"created_at":null}',
